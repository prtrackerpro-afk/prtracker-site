    ...
    const result = await preferenceApi.create({
      body: {
        ...
        payment_methods: {
          ...
          // "pré-pago" / "débito virtual CAIXA" — fazer isso acabou
          // desabilitando o botão Pagar/Criar Pix pra várias combinações.
          // A UX do MP com opções extras é aceitável vs. bloquear
          // pagamento de vez.
